...
**👁️ Computer Vision:**
- Inspekcje instalacji dronami
- Analiza obrazów termicznych
- Monitoring wizualny
...
- Słaba generalizacja na nowe dane
- Brak stabilności modelu

**📊 Bias danych:**
- Brak reprezentatywności danych
- Nierówności w zbiorach treningowych
- Błędy systematyczne

**📈 Data drift:**
- Zmiany w danych w czasie
- Degradacja modeli
- Potrzeba rekalkibracji
