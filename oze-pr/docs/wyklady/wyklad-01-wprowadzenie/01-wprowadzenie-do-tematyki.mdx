...
**🎯 Cel kursu:**
- **Klasyfikacja i architektura** narzędzi programowych OZE
- **Systemy fotowoltaiczne** - PV*SOL, Sunny Design, PVsyst, Aurora, PVGIS
...
- **Biomasa i biogaz** - Simba-BioWin, procesy modelowania
...
**🔧 Klasyfikacja narzędzi:**
- **CAD (Computer-Aided Design)** - modelowanie geometryczne, dokumentacja techniczna, wizualizacja projektów. Computer-Aided=Wspomagane komputerowo
  - *Przykłady:* AutoCAD, SolidWorks, SketchUp, Revit, Fusion 360
- **CAE (Computer-Aided Engineering)** - obliczenia wytrzymałościowe, symulacje fizyczne, analizy numeryczne
  - *Przykłady:* ANSYS, COMSOL, MATLAB/Simulink, OpenFOAM, Abaqus
...
- **AI** - machine learning, computer vision, NLP
  - *Zastosowania:* Optymalizacja produkcji energii, predykcyjne utrzymanie, analiza obrazów satelitarnych, automatyczne raportowanie
- **IoT** - inteligentne czujniki, edge computing
  - *Zastosowania:* Monitoring w czasie rzeczywistym, sterowanie inteligentnymi sieciami, optymalizacja zużycia energii
- **Blockchain** - handel P2P energią, smart contracts
  - *Technologia:* Rozproszona baza danych z niezmiennymi rekordami transakcji, automatyczne wykonanie umów
  - *Zastosowania:* Handel energią między sąsiadami, certyfikaty pochodzenia energii, transparentne rozliczenia
- **Digital twins** - wirtualne repliki instalacji, symulacje w czasie rzeczywistym
  - *Zastosowania:* Testowanie strategii eksploatacji, optymalizacja bez ryzyka, szkolenia operatorów
